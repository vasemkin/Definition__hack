...
const {LimitOrderBuilder, LimitOrderProtocolFacade} = require('@1inch/limit-order-protocol');
...
module.exports = async function (limitOrder) {
    ...
    const callData = limitOrderProtocolFacade.fillLimitOrder(limitOrder, '0x00', limitOrder.makerAmount, 0, 5000000000);
